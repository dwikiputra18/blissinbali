...
<footer class="bg-[#087F91] text-gray-300 pt-16 pb-8">
        ...
        <div class="mb-14">
            ...
            <div class="flex flex-col md:flex-row md:items-center gap-6 mb-8">
                ...
                >
                    ...
                    >
                        <img
                            src="<?php echo e(asset('/logo-footer.PNG')); ?>"
                            alt="Bliss in Bali"
    ...
    <div class="flex items-start gap-3 min-w-0">
        ...
        >
            ...
            <p class="text-center md:text-left leading-relaxed">
                ...
                &copy; <?php echo e(date('Y')); ?> Bliss in Bali.
                All rights reserved.
...
<?php /**PATH /home/dwiki/Documents/website/blissinbali/resources/views/partials/front-footer.blade.php ENDPATH**/ ?>