            ...
            <div class="p-8">
                <div class="flex flex-col md:flex-row gap-6 mb-8 pb-8 border-b border-gray-100">
                    <div class="w-full md:w-40 h-40 rounded-2xl overflow-hidden flex-shrink-0">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($booking->carRental->image): ?>
                            <img src="<?php echo e(Storage::url($booking->carRental->image)); ?>" class="w-full h-full object-cover">
                        <?php else: ?>
                    ...
                    <div class="flex-1">
                        ...
                        <h2 class="text-2xl font-bold text-gray-800 mb-2"><?php echo e($booking->carRental->name); ?></h2>
                        <p class="text-gray-500 text-sm flex items-center gap-2">
                            <i class="far fa-calendar-alt"></i> <?php echo e($booking->rental_date); ?>
                    ...
                    <div>
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium text-gray-800"><?php echo e($booking->phone); ?></span>
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="space-y-3 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span class="font-mono font-bold text-blue-950"><?php echo e($booking->booking_code); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500">Duration</span>
                                <span class="font-medium text-gray-800"><?php echo e($booking->rental_days); ?> Day(s)</span>
                            </div>
                            <div class="pt-3 border-t border-dashed flex justify-between items-center">
                                ...
                                <span class="text-xl font-black text-yellow-600">Rp <?php echo e(number_format($booking->total_amount, 0, ',', '.')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    payButton.onclick = function (e) {
        ...
        window.snap.pay('<?php echo e($snapToken); ?>', {
            onSuccess: function (result) {
                window.location.href = "<?php echo e(route('car-rental.checkout.success', $booking->booking_code)); ?>";
            },
            onPending: function (result) {
                window.location.href = "<?php echo e(route('car-rental.checkout.pending', $booking->booking_code)); ?>";
            },
            onError: function (result) {
                window.location.href = "<?php echo e(route('car-rental.checkout.error', $booking->booking_code)); ?>";
            },
            onClose: function () {
...
<?php echo $__env->make('layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dwiki/Documents/website/blissinbali/resources/views/car-rental/payment.blade.php ENDPATH**/ ?>