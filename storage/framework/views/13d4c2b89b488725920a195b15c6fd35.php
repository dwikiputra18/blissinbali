<?php $__env->startSection('title', 'Rent ' . $carRental->name . ' - Checkout'); ?>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                <form id="carCheckoutForm" action="<?php echo e(route('car-rental.checkout.process', $carRental)); ?>" method="POST"
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-2xl shadow-sm p-6 sticky top-24 border border-gray-100">
                    ...
                    <div class="bg-gray-50 rounded-xl overflow-hidden mb-5">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($carRental->image): ?>
                        <img src="<?php echo e(Storage::url($carRental->image)); ?>" class="w-full h-32 object-cover">
                        <?php else: ?>
                        ...
                        <div class="p-4 border-t border-gray-100 bg-white">
                            <p class="font-bold text-gray-800 text-lg"><?php echo e($carRental->name); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3 text-sm text-gray-600 mb-4 pb-4 border-b border-gray-100">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-gray-800" id="basePrice" data-price="<?php echo e($price); ?>">Rp <?php echo e(number_format($price, 0, ',', '.')); ?></span>
                        </div>
...
<?php echo $__env->make('layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dwiki/Documents/website/blissinbali/resources/views/car-rental/checkout.blade.php ENDPATH**/ ?>