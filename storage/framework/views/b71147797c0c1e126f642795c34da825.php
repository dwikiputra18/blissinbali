...
<div class="pt-24 pb-16 bg-[#F8F9FA] min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8" x-data="tourBooking({
            ...
            price_1_pax: <?php echo e($tourPackage->price_1_pax ?? 0); ?>,
...
<?php echo $__env->make('layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dwiki/Documents/website/blissinbali/resources/views/checkout/index.blade.php ENDPATH**/ ?>