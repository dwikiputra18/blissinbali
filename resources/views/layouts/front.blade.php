...
<head>
    ...
    {{-- ══════════════════════════════════════════════════ --}}
    {{-- SEO & Open Graph / Social Media Meta Tags         --}}
    {{-- ══════════════════════════════════════════════════ --}}
    @php
...
<body class="bg-[#F8F9FA] text-[#1A1A1A] antialiased overflow-x-hidden selection:bg-[#C68A36] selection:text-white {{ request()->routeIs('tour.index') ? 'page-tour-index' : (request()->routeIs('tour.show') ? 'page-tour-show' : (request()->routeIs('home') || request()->is('/') ? 'page-home' : '')) }}">
    ...
    <div id="gateIntro" class="gate-intro" aria-label="Welcome to Bliss in Bali">
        ...
        <div class="gate-content">
            <img src="{{ asset('logo.png') }}" alt="Bliss in Bali" class="gate-logo">
